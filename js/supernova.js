...
function createObjects() {
    ...
    for (var j = 0; j < 3; j++) {
		...
		var nebMaterial = new THREE.SpriteMaterial( { map: nebTexture, useScreenCoordinates: false, name: 'clouds'} );
    ...
    for (var j = 0; j < 30; j++) {
		...
		var starMaterial = new THREE.SpriteMaterial( { map: starTexture, useScreenCoordinates: false} );
